...
public:
	...
	bool ReadString	 (const TCHAR* pSection,  const TCHAR* pEntry, std::string& strItem);
	bool ReadInt (const TCHAR* pSection,  const TCHAR* pEntry, int& nValue);
	bool ReadInt (const TCHAR* pSection,  const TCHAR* pEntry, short& nValue);
