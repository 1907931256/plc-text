...
void CIniFile::ReadString(const char* pSection, const char* pEntry, std::string& strItem)
{
...
void CIniFile::ReadInt(const char* pSection, const char* pEntry, short& nValue)
{
	int nIntValue = 0;
